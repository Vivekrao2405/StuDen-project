...
// returned by this endpoint in the first place). Carries the caller's own progress inline so the
// detail page never needs a second round-trip.
public record ResourceResponse(
    ...
    public static ResourceResponse from(Resource entity, ResourceProgressStatus progressStatus) {
        return new ResourceResponse(entity.getId(), entity.getTitle(), entity.getDescription(),
                ...
                entity.getNotesContent(), List.copyOf(entity.getTags()), progressStatus);
    }
}
