...
// JpaSpecificationExecutor backs com.studen.communication.audience.AudienceService — the one
// place in the app that needs dynamic, admin-built AND/OR predicates rather than a fixed @Query.
